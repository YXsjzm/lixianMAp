...
window.ARGS = {
	...
	maptile : "http://k1268.mlamp.co/maptile"//图片路径
};
...
window.BMAP_AUTHENTIC_KEY = "";//eES0TPsD9eZmPK2W73chYZlv 
(function() {
	function aa(a) {
		throw a;
	}
	...
	8 > x.S.ba ? (ka["for"] = "htmlFor", ka["class"] = "className") : (ka.htmlFor = "for", ka.className = "class");
	x.B.dG = ka;
	...
	x.B.rl.filter = function(a, b, c) {
		for (var d = 0, e = x.B.rl, f; f = e[d]; d++) if (f = f[c]) b = f(a, b);
		return b
	};
	x.zk.MN = function(a) {
	...
	x.B.V = function(a) {
		...
		var e = {
			...
			f;
		if (a == (c.ba && !c.$D ? b.body : b.documentElement)) return e;
		if (a.getBoundingClientRect) {
			...
			if (c.opera > 0 || c.HL > 0 && d(a, "position") == "absolute") e.top = e.top - b.body.offsetTop;
	...
	x.qK = function() {
		function a(a) {
			document.addEventListener && (this.element = a, this.tK = this.ik ? "touchstart" : "mousedown", this.WC = this.ik ? "touchmove" : "mousemove", this.VC = this.ik ? "touchend" : "mouseup", this.dh = q, this.Lt = this.Kt = 0, this.element.addEventListener(this.tK, this, q), ja.F(this.element, "mousedown", s()), this.handleEvent(p))
		}
		a.prototype = {
			...
			move: function(a) {
				...
				if (10 < Math.abs((this.ik ? a.touches[0].clientX : a.clientX) - this.Kt) || 10 < Math.abs(c - this.Lt)) this.dh = o
			},
			end: function(a) {
				oa(a);
				this.dh || (a = document.createEvent("Event"), a.initEvent("tap", q, o), this.element.dispatchEvent(a));
	...
	function Ka(a, b) {
		if (a = x.N(a)) {
			...
			c.D.ie && (this.rX(c.D.ie.controls), this.uL(c.D.ie.geotableId));
			...
			var d = c.D.rU;
			if (G()) for (var e = 0, f = d.length; e < f; e++) if (x.S[d[e]]) {
			...
			if (-1 < navigator.userAgent.toLowerCase().indexOf("UCBrowser") || d && e) c.D.uF = 99;
			c.Ja = a;
			c.dB(a);
			a.unselectable = "on";
			a.innerHTML = "";
			...
			for (e = 0; e < z.jr.length; e++) z.jr[e](c);
			c.H.HE = e;
			c.P();
			I.load("map", function() {
				c.tb()
	...
	x.extend(Ka.prototype, {
		...
		Rj: function(a, b, c, d) {
			var e = this.la().Bc(this.U()),
				f = this.le,
				g = o;
			c && H.zL(c) && (this.Te = new H(c.lng, c.lat), g = q);
			if (c = c && d ? f.sm(c, this.Kb) : this.kc) if (this.kc = new H(c.lng + a * e, c.lat - b * e), (a = f.bh(this.kc, this.Kb)) && g) this.Te = a
		},
		sg: function(a, b) {
			if (Ua(a) && (this.Bu(), this.dispatchEvent(new N("onzoomstart")), a = this.En(a).zoom, a !== this.wa)) {
				this.xc = this.wa;
				this.wa = a;
				var c;
				b ? c = b : this.Vg() && (c = this.Vg().V());
				c && (c = this.Vb(c, this.xc), this.Rj(this.width / 2 - c.x, this.height / 2 - c.y, this.ob(c, this.xc), o));
		...
		hi: function(a) {
			a instanceof H && (this.kc = this.le.sm(a, this.Kb), this.Te = H.zL(a) ? new H(a.lng, a.lat) : this.le.bh(this.kc, this.Kb))
		},
		mg: function(a, b) {
			a = Math.round(a) || 0;
			b = Math.round(b) || 0;
		...
		Uv: function(a) {
			a && Va(a.Oe) && (a.Oe(this), this.dispatchEvent(new N("onaddcontrol", a)))
		},
		TM: function(a) {
			a && Va(a.remove) && (a.remove(), this.dispatchEvent(new N("onremovecontrol", a)))
		},
		bo: function(a) {
			a && Va(a.fa) && (a.fa(this), this.dispatchEvent(new N("onaddcontextmenu", a)))
		},
		hp: function(a) {
			a && Va(a.remove) && (this.dispatchEvent(new N("onremovecontextmenu", a)), a.remove())
		},
		ya: function(a) {
			a && Va(a.Oe) && (a.Oe(this), this.dispatchEvent(new N("onaddoverlay", a)))
		},
		Hb: function(a) {
		...
		Jf: function(a) {
			var b = this;
			if (a instanceof H) b.hi(a, {
				noAnimation: o
			});
			else if (Xa(a)) if (b.wb === Na) {
				var c = F.NB[a];
				c && (pt = c.m, b.Jf(pt))
			} else {
				var d = this.iH();
				d.$E(function(c) {
					0 === d.cm() && 2 === d.ta.result.type && (b.Jf(c.gk(0).point), Na.ck(a) && b.WE(a))
				});
				d.search(a, {
					log: "center"
				})
		...
		be: function(a, b) {
			...
			if (Xa(a)) if (c.wb === Na) {
				...
				c.xc !== c.wa && (d = new N("onzoomend"), d.LG = "centerAndZoom", c.dispatchEvent(d));
				c.D.wo && c.wo()
			}
		},
		iH: function() {
		...
		sV: function() {
			this.D.wo = q;
			this.qn && (this.lh(this.qn), this.qn = p, delete this.qn)
		},
		kb: function() {
			return this.Vr && this.Vr instanceof L ? new L(this.Vr.width, this.Vr.height) : new L(this.Ja.clientWidth, this.Ja.clientHeight)
		},
		yd: function(a) {
			a && a instanceof L ? (this.Vr = a, this.Ja.style.width = a.width + "px", this.Ja.style.height = a.height + "px") : this.Vr = p
		},
		Aa: t("Te"),
		U: t("wa"),
		JU: function() {
		...
		K2: function(a, b) {
			var c = map.Kb;
			this.wb === Na && c && (a.x += this.offsetX, a.y += this.offsetY, db.MJ(a, this, b))
		},
		Pd: function(a) {
			if (!this.qx()) return new eb;
			var b = a || {},
				a = b.margins || [0, 0, 0, 0],
				c = b.zoom || p,
				b = this.ob({
		...
		Is: function(a, b) {
			...
			if (!a || !a instanceof eb && 0 === a.length || a instanceof eb && a.kj()) return c;
			var d = [];
			a instanceof eb ? (d.push(a.Cf()), d.push(a.Ee())) : d = a.slice(0);
			for (var b = b || {}, e = [], f = 0, g = d.length; f < g; f++) e.push(this.le.sm(d[f], this.Kb));
			d = new eb;
		...
		la: t("wb"),
		Xy: function() {
			for (var a = this.H.HE; a < z.jr.length; a++) z.jr[a](this);
			this.H.HE = a
		},
		WE: function(a) {
			this.Kb = Na.ck(a);
		...
		Wv: function(a, b) {
			...
			a.tag = b;
			a instanceof hb && (this.Bh[b][a.Q] = a, a.fa(this));
			var c = this;
		...
		wt: function(a) {
			...
			if (a) {
				...
				}, 50) : (this.D.ie = a, this.dispatchEvent(new N("onsetcustomstyles", a)), this.uL(b.D.ie.geotableId));
				var c = {
					style: a.style
				};
		...
		rX: function(a) {
			...
			var b = this,
				c;
			for (c in this.controls) b.TM(b.controls[c]);
			a = a || [];
		...
		uL: function(a) {
			a ? this.Tr && this.Tr.jf === a || (this.lh(this.Tr), this.Tr = new mb({
				geotableId: a
		...
		if (a) {
			...
			var e = function(a) {
					a && (nb = o, setTimeout(function() {
						ob.src = ARGS.miningmap + "/resources/default/images/blank.gif"//z.vc + "images/blank.gif?" + a.src
					}, 50))
				},
				f = function() {
					var a = pb.shift();
	...
	z.mX = {
		...
		main_domain_cdn: {
			baidu: [ARGS.url+"/resources/default","api0.map.bdimg.com", "api1.map.bdimg.com", "api2.map.bdimg.com"],
	...
	z.hg = function(a, b) {
		...
		case "main_domain_cdn":
			...
			break;
		default:
			d = z.url.domain[a], "[object Array]" == Object.prototype.toString.call(d) ? (c = [], x.Yb.sb(d, function(a, d) {
				c[d] = z.url.proto + a + "/" + b
	...
	function vb(a) {
		var b = $a();
		b >= a.Ez ? (Va(a.k.ja) && a.k.ja(a.k.Xb(1)), Va(a.k.finish) && a.k.finish(), 0 < a.Nf.length && (b = a.Nf[0], b.Nf = [].concat(a.Nf.slice(1)), b.start())) : (a.$x = a.k.Xb((b - a.uu) / a.k.duration), Va(a.k.ja) && a.k.ja(a.$x), a.iF || (a.zr = setTimeout(function() {
			vb(a)
		}, 1E3 / a.k.wc)))
	}
	sb.prototype.stop = function(a) {
		...
		this.Nf.length = 0;
		this.zr && (clearTimeout(this.zr), this.zr = p);
		this.k.bt(this.$x);
		a && (this.Ez = this.uu, vb(this))
	};
	...
	var F = {
		...
		tO: new L(12, 36),
		AF: new L(13, 1),
		ea: ARGS.miningmap + "/resources/default/images/",//z.ca + "images/", 
		f2: "http://api0.map.bdimg.com/images/", 
		BF: ARGS.miningmap + "/resources/default/images/markers_new.png",//z.ca + "images/markers_new.png",
		rO: 24,
		sO: 73,
		NB: {
			"\u5317\u4eac": {
			...
			function g(a) {
				if (!a.ro) {
					for (var c = o, d = [], f = a.IY, i = 0; f && i < f.length; i++) {
						var k = f[i],
							l = ea[k] = ea[k] || {};
						if (l.ro || l == a) d.push(l.Cc);
						else {
							c = q;
							if (!l.lV && (k = (ta.get("alias") || {})[k] || k + ".js", !J[k])) {
								J[k] = o;
			...
			if (!B || !B.ro) {
				var A = b.all && a.attachEvent,
					...
					O = function(a) {
						...
						if ("define" == a || "require" == a) {
							...
							c = !c ? "#" + E++ : c;
							d = ea[c] = ea[c] || {};
							d.ro || (d.name = c, d.IY = e, d.UJ = f, "define" == a && (d.lV = o), g(d))
				...
				w.prototype.start = w.prototype.create = function(a) {
					if (!this.TJ) {
						...
						this.TJ = new Date;
						for (this.os("create", this); a = this.rJ.shift();) u.apply(this, a)
					}
				};
	...
	x.object.extend(I, {
		...
		P2: {},
		KF: {
			rP: ARGS.miningmap + "/resources/default/js/",//z.ca + "getmodules?v=2.0&t=20140707",
			PT: 5E3
		},
		kC: q,
		Cd: {
		...
		load: function(a, b, c) {
			var d = this.Va(a);
			if (d.od == this.rj.Jp) c && b();
			else {
				if (d.od == this.rj.RF) {
					this.JJ(a);
					this.QM(a);
					var e = this;
					e.kC == q && (e.kC = o, setTimeout(function() {
						for (var a = [], b = 0, c = e.Cd.hn.length; b < c; b++) {
							var d = e.Cd.hn[b],
								l = "";
							ja.oy.CJ(d) ? l = ja.oy.get(d) : (l = "", a.push(d + "_" + Qb[d]));
							e.Cd.zv.push({
								jM: d,
								pE: l
							})
						...
						e.kC = q;
						e.Cd.hn.length = 0;
						0 == a.length ? e.sK() : Pb(e.KF.rP +  "modules.js")//"&mod=" + a.join(",")
					}, 1));
					d.od = this.rj.aP
				}
				d.yu.push(b)
		...
		JJ: function(a) {
			if (a && this.NK()[a]) for (var a = this.NK()[a], b = 0; b < a.length; b++) this.JJ(a[b]), this.Cd.Zk[a[b]] || this.QM(a[b])
		},
		QM: function(a) {
			for (var b = 0; b < this.Cd.hn.length; b++) if (this.Cd.hn[b] == a) return;
			this.Cd.hn.push(a)
		},
		OY: function(a, b) {
			var c = this.Va(a);
			...
			c.od = this.rj.Jp;
			for (var e = 0, f = c.yu.length; e < f; e++) c.yu[e]();
			c.yu.length = 0
		},
		CJ: function(a, b) {
			var c = this;
			c.timeout = setTimeout(function() {
				c.Cd.Zk[a].od != c.rj.Jp ? (c.remove(a), c.load(a, b)) : clearTimeout(c.timeout)
			}, c.KF.PT)
		},
		Va: function(a) {
			this.Cd.Zk[a] || (this.Cd.Zk[a] = {}, this.Cd.Zk[a].od = this.rj.RF, this.Cd.Zk[a].yu = []);
			return this.Cd.Zk[a]
		},
		remove: function(a) {
			delete this.Va(a)
		...
		GU: function(a, b) {
			for (var c = this.Cd.zv, d = o, e = 0, f = c.length; e < f; e++)"" == c[e].pE && (c[e].jM == a ? c[e].pE = b : d = q);
			d && this.sK()
		},
		sK: function() {
			for (var a = this.Cd.zv, b = 0, c = a.length; b < c; b++) this.OY(a[b].jM, a[b].pE);
			this.Cd.zv.length = 0
		}
	});
	...
	function hb(a, b) {
		a && (this.zb = a, this.Q = "spot" + hb.Q++, b = b || {}, this.Jg = b.text || "", this.fv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.QI = b.userData || p, this.Dh = b.minZoom || p, this.of = b.maxZoom || p)
	}
	hb.Q = 0;
	...
	x.extend(Rb.prototype, {
		...
		remove: function() {
			this.C = p;
			this.A && (this.A.parentNode && this.A.parentNode.removeChild(this.A), this.A = this.A.Pq = p)
		},
		ra: function() {
		...
		nc: function(a) {
			if (this.y0 || !Ua(a) || isNaN(a) || a < Sb || 3 < a) a = this.defaultAnchor;
			this.k = this.k || {
				ih: q
			};
		...
		td: t("A"),
		show: function() {
			this.Fa != o && (this.Fa = o, this.A && x.B.show(this.A))
		},
		J: function() {
			this.Fa != q && (this.Fa = q, this.A && x.B.J(this.A))
		},
		...
		Vv: function(a) {
			if (a && Ua(a.id) && !isNaN(a.id)) {
				var b = {
					...
					c;
				for (c in a) b[c] = a[c];
				if (a = this.Xl(a.id)) for (var d in b) a[d] = b[d];
				else this.Rb.push(b)
			}
		},
		Xl: function(a) {
	...
	x.object.extend(ac.prototype, {
		...
		KE: function(a) {
			if (this.oe[a]) {
				for (var b = 0, c = this.na.length; b < c; b++) this.na[b] && ("divider" == this.na[b].Ab && this.na[b].zj == a) && (this.na.splice(b, 1), c--), this.na[b] && ("divider" == this.na[b].Ab && this.na[b].zj > a) && this.na[b].zj--;
				this.oe.splice(a, 1)
			}
		},
		td: t("A"),
	...
	function eb(a, b) {
		...
		a && (this.sl = new H(a.lng, a.lat), this.bl = new H(b.lng, b.lat), this.xe = a.lng, this.we = a.lat, this.se = b.lng, this.re = b.lat)
	}
	x.object.extend(eb.prototype, {
		...
		Os: function(a) {
			if (!(a instanceof eb) || Math.max(a.xe, a.se) < Math.min(this.xe, this.se) || Math.min(a.xe, a.se) > Math.max(this.xe, this.se) || Math.max(a.we, a.re) < Math.min(this.we, this.re) || Math.min(a.we, a.re) > Math.max(this.we, this.re)) return p;
		...
		extend: function(a) {
			if (a instanceof H) {
				...
				if (!this.xe || this.xe > b) this.sl.lng = this.xe = b;
				if (!this.se || this.se < b) this.bl.lng = this.se = b;
				if (!this.we || this.we > a) this.sl.lat = this.we = a;
				if (!this.re || this.re < a) this.bl.lat = this.re = a
			}
		},
		nF: function() {
	...
	x.extend(R, {
		...
		Gb: function(a) {
			...
			a.lat = this.yD(a.lat, -74, 74);
			b = new H(a.lng, a.lat);
			for (var d = 0; d < this.ju.length; d++) if (b.lat >= this.ju[d]) {
				c = this.SF[d];
				break
			}
			if (!c) for (d = this.ju.length - 1; 0 <= d; d--) if (b.lat <= -this.ju[d]) {
				c = this.SF[d];
				break
			}
			a = this.OJ(a, c);
	...
	x.extend(R.prototype, {
		...
		Vb: function(a, b, c, d, e) {
			if (a) return a = this.sm(a, e), b = this.Bc(b), new Q(Math.round((a.lng - c.lng) / b + d.width / 2), Math.round((c.lat - a.lat) / b + d.height / 2))
		},
		ob: function(a, b, c, d, e) {
			if (a) return b = this.Bc(b), this.bh(new H(c.lng + b * (a.x - d.width / 2), c.lat - b * (a.y - d.height / 2)), e)
		},
		Bc: function(a) {
	...
	z.He(function(a) {
		...
		a.addEventListener("addoverlay", function(a) {
			...
			if (a instanceof fb) b.ka[a.Q] || (b.ka[a.Q] = a);
				...
				for (var d = q, e = 0, f = b.ne.length; e < f; e++) if (b.ne[e] === a) {
					d = o;
					break
				}
				d || b.ne.push(a)
		...
		a.addEventListener("removeoverlay", function(a) {
			...
			else for (var d = 0, e = b.ne.length; d < e; d++) if (b.ne[d] === a) {
				b.ne.splice(d, 1);
				break
			}
		});
		a.addEventListener("clearoverlays", function() {
			this.Mc();
			for (var a in b.ka) b.ka[a].z.Vh && (b.ka[a].remove(), delete b.ka[a]);
			a = 0;
			for (var d = b.ne.length; a < d; a++) b.ne[a].Vh !== q && (b.ne[a].remove(), b.ne[a] = p, b.ne.splice(a, 1), a--, d--)
		});
		a.addEventListener("infowindowopen", function() {
			var a = this.lb;
			a && (x.B.J(a.lc), x.B.J(a.Qb))
		});
	...
	function jc(a) {
		...
		if (0 > this.z.ed || 1 < this.z.ed) this.z.ed = 0.65;
	...
	x.extend(jc.prototype, {
		...
		fe: t("W"),
		Pm: function(a, b) {
			b && this.W[a] && (this.Re.length = 0, this.W[a] = new H(b.lng, b.lat), this.qh())
		},
	...
	function nc(a, b, c, d) {
		a && (this.kv = {}, this.yK = d ? !! d : q, this.Kc = [], this.LZ = a instanceof mc ? a : p, this.cI = b === j ? o : !! (b.indexOf("%") + 1), this.Kj = isNaN(parseFloat(b)) ? 1 : this.cI ? parseFloat(b) / 100 : parseFloat(b), this.dI = !! (c.indexOf("%") + 1), this.repeat = c != j ? this.dI ? parseFloat(c) / 100 : parseFloat(c) : 0)
	};
	...
	fb.prototype.Bb = function(a) {
		this.map && (this.map.Mc(), a.Fa = o, this.map.H.Tk = a, a.Qa = this, x.lang.qa.call(a, a.Q))
	};
	fb.prototype.Mc = function() {
		this.map && this.map.H.Tk && (this.map.H.Tk.Fa = q, x.lang.zw(this.map.H.Tk.Q), this.map.H.Tk = p)
	};
	...
	function uc(a, b) {
		...
		tc() && (a === j && aa(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && aa(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, fb.apply(c, arguments), c.R = {
			...
			Vh: o
		}, this.OA = [], this.ae = [], I.load("pointcollection", function() {
			for (var a = 0, b; b = c.OA[a]; a++) c[b.method].apply(c, b.arguments);
			for (a = 0; b = c.ae[a]; a++) c[b.method].apply(c, b.arguments)
		}))
	}
	...
	x.extend(T.prototype, {
		Ib: function(a) {
			if (a instanceof lc || a instanceof mc) this.z.hj = a
		},
		Go: function() {
			return this.z.hj
		},
	...
	x.extend(xc.prototype, {
		...
		Pm: function(a, b) {
			this.Zn[a] && (this.Zn[a] = new H(b.lng, b.lat), this.W[a] = new H(b.lng, b.lat), 0 == a && !this.W[0].$a(this.W[this.W.length - 1]) && (this.W[this.W.length - 1] = new H(b.lng, b.lat)), this.qh())
		},
		fe: function() {
			var a = this.Zn;
			0 == a.length && (a = this.W);
	...
	x.extend(Bc.prototype, {
		...
		hf: function() {
			this.eh--;
			var a = this;
			this.VD && (this.map.dispatchEvent(new N("onfirsttileloaded")), this.VD = q);
			0 == this.eh && (this.Ai && (clearTimeout(this.Ai), this.Ai = p), this.Ai = setTimeout(function() {
				if (a.eh == 0) {
		...
		fm: function(a, b, c) {
			...
			for (this.Gc ? this.Gc.length = 0 : this.Gc = []; l < n; l++) for (var w = m; w < u; w++) {
				var y = l,
					B = w;
				this.Gc.push([y, B]);
				y = k + "_" + b + "_" + y + "_" + B + "_" + f;
			...
			l = 0;
			for (d = a.childNodes.length; l < d; l++) w = a.childNodes[l], w.Mq = q, this.ye.push(w);
			...
			for (d = this.Gc.length; l < d; l++) {
				...
				i = this.Gc[l][1];
				w = 0;
				for (m = this.ye.length; w < m; w++) if (n = this.ye[w], n.id == k + "_" + b + "_" + A + "_" + i + "_" + f) {
					n.Mq = o;
					this.zm[n.id] = n;
					break
				}
			...
			l = 0;
			for (d = this.ye.length; l < d; l++) n = this.ye[l], n.Mq || this.ze.push(n);
			this.Um = [];
			w = (e + c) * this.map.D.devicePixelRatio;
			l = 0;
			for (d = this.Gc.length; l < d; l++) A = this.Gc[l][0], i = this.Gc[l][1], u = A * e + g[0] - c / 2, v = (-1 - i) * e + g[1] - c / 2, y = k + "_" + b + "_" + A + "_" + i + "_" + f, m = this.zm[y], n = p, m ? (n = m.style, n.left = u + "px", n.top = v + "px", m.Me || this.Um.push([A, i, m])) : (0 < this.ze.length ? (m = this.ze.shift(), m.getContext("2d").clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement("canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height = e + c + "px", this.tx() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute("height", w), a.appendChild(m)), m.id = y, n.left = u + "px", n.top = v + "px", -1 < y.indexOf("bg") && (u = "#F3F1EC", this.map.D.io && (u = this.map.D.io), n.background = u ? u : ""), this.Um.push([A, i, m])), m.style.visibility = "";
			l = 0;
			for (d = this.ze.length; l < d; l++) this.ze[l].style.visibility = "hidden";
			return this.Um
		},
		tx: function() {
		...
		AZ: function(a, b, c, d) {
			...
			var f = this.map.la(),
				...
				k = this.kg[g];
			k && k.vb ? (wb(k.vb, b), d && (d = new Q(a[0], a[1]), f = this.map.D.ie ? this.map.D.ie.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ec(k, d)), k.loaded ? this.hf() : Fc(k, function() {
				e.hf()
			})) : (k = this.Si[g]) && k.vb ? (c.Eb.insertBefore(k.vb, c.Eb.lastChild), this.kg[g] = k, wb(k.vb, b), d && (d = new Q(a[0], a[1]), f = this.map.D.ie ? this.map.D.ie.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ec(k, d)), k.loaded ? this.hf() : Fc(k, function() {
				e.hf()
			})) : (k = i * Math.pow(2, f.Zl() - a[2]), new H(a[0] * k, a[1] * k), d = new Q(a[0], a[1]), f = this.map.D.ie ? this.map.D.ie.style : "normal", d = c.getTilesUrl(d, a[2], f), k = new Gc(this, d, b, a, c), Fc(k, function() {
				e.hf()
			}), k.Jn(), this.kg[g] = k)
		},
		hf: function() {
		...
		lx: function(a) {
			var b = a.vb;
			b && (Hc(b), yb(b) && b.parentNode.removeChild(b));
			delete this.kg[a.name];
			a.loaded || (Hc(b), Dc(a), a.vb = p, a.wm = p)
		},
		Hf: function(a) {
			var b = this;
			if (b.map.la() == Na) I.load("coordtrans", function() {
				b.map.Kb || (b.map.Kb = Na.ck(b.map.no), b.map.kw = Na.JK(b.map.Kb));
				b.KH()
			}, o);
			else {
			...
			for (var b = this.tm.concat(this.Kf), c = b.length, d = 0; d < c; d++) {
				...
				if (e.cw) {
					...
					if (this.map.Jb()) {
						...
						continue
					} else f.style.display = "block", this.$c.style.display = "none", this.map.dispatchEvent(new N("vectorchanged"), {
						isvector: q
					})
				}
				if (!e.BH && !(e.Xo && !this.map.Jb() || e.GL && this.map.Jb())) {
					...
					e.Eb && (e.Eb.style.left = Math.ceil(v + y) - u[0] + "px", e.Eb.style.top = Math.ceil(w + A) - u[1] + "px", e.Eb.style.WebkitTransform = "translate3d(0,0,0)");
					v = [];
					for (l.sB = []; k < g; k++) for (w = f; w < m; w++) v.push([k, w]), l.sB.push({
						x: k,
						y: w
					});
					v.sort(function(a) {
					...
					i = v.length;
					this.eh += i;
					for (k = 0; k < i; k++) this.AZ([v[k][0], v[k][1], n], u, e, a)
				}
			}
		},
		Mg: function(a) {
			var b = this,
				c = a.target,
				a = b.map.Jb();
			if (c instanceof bb) a && !c.nm && (c.fa(this.map, this.$c), c.nm = o);
			else if (c.Lf && this.map.Mg(c.Lf), c.Xo) {
				...
				for (a = 0; a < b.Kf.length; a++) if (b.Kf[a] == c) return;
		...
		lh: function(a) {
			var a = a.target,
				b = this.map.Jb();
			if (a instanceof bb) b && a.nm && (a.remove(), a.nm = q);
			else {
				a.Lf && this.map.lh(a.Lf);
				if (a.Xo) for (var b = 0, c = this.rg.length; b < c; b++) a == this.rg[b] && this.rg.splice(b, 1);
				else {
					b = 0;
					for (c = this.Kf.length; b < c; b++) a == this.Kf[b] && this.Kf.splice(b, 1)
				}
				a.remove()
			}
		},
		...
		wt: function(a) {
			var b = this.map.la();
			if (!this.map.Jb() && (a ? this.map.D.IZ = a : a = this.map.D.IZ, a)) for (var c = p, c = "2" == z.Yt ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.tm[d]; d++) if (e.vZ == o) {
				b.k.Nb = 18;
		...
		this.vb.onload = function() {
			...
			if (g.wm) {
				...
				if (g.vb && !yb(g.vb) && e.Eb) {
					...
					if (x.S.ba <= 6 && x.S.ba > 0 && g.MI) g.vb.style.cssText = g.vb.style.cssText + (';filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + g.src + '",sizingMethod=scale);')
				}
				var c = a.GE - a.CU,
					d;
				for (d in b) {
				...
				Ic && new sb({
					...
					duration: 200,
					ja: function(a) {
						if (g.vb && g.vb.style) g.vb.style.opacity = a * 1
					},
					finish: function() {
	...
	function Hc(a) {
		if (a) {
			...
			if (b = a.children) {
				d = b.length;
				for (c = 0; c < d; c += 1) Hc(a.children[c])
			}
		}
	}
	function Ec(a, b) {
	...
	x.extend(Cc.prototype, {
		...
		remove: function() {
			this.Eb && this.Eb.parentNode && (this.Eb.innerHTML = "", this.Eb.parentNode.removeChild(this.Eb));
			delete this.Eb
		},
		Us: t("g_"),
		getTilesUrl: function(a, b) {
			var c = "";
			this.fh.tileUrlTemplate && (c = this.fh.tileUrlTemplate.replace(/\{X\}/, a.x), c = c.replace(/\{Y\}/, a.y), c = c.replace(/\{Z\}/, b));
			return c
		},
		Xl: t("WU"),
		la: function() {
	...
	function mb(a, b) {
		...
		d && (this.Lf = new Jc(a, b), this.Lf.uy = this);
		Gb(a) ? b = a || {} : (c.yn = a, b = b || {});
	...
	mb.prototype.getTilesUrl = function(a, b) {
		var c = a.x,
			d = a.y,
			e = this.bc,
			c = Mc[Math.abs(c + d) % Mc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.Fm + "&tags=" + e.Ot + "&filter=" + e.filter + "&sortby=" + e.my +  "&age=" + e.$v + "&page_size=" + e.OM + "&format=" + e.QZ;
	...
	Tc.getTilesUrl = function(a, b, c) {
		...
		return (ARGS.maptile + "/" + b + "/" + d + "/" + a + ".jpg").replace(/-(\d+)/gi, "M$1")
	};
	var La = new Pc("\u5730\u56fe", Tc, {
		tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
		maxZoom: 19
	...
	Na.ck = function(a) {
		...
		var b = F.NB,
			c;
		for (c in b) if (-1 < a.search(c)) return b[c].Qx;
		return ""
	};
	Na.JK = function(a) {
		return {
	...
	Vc.getTilesUrl = function(a, b) {
		...
		return (ARGS.maptile + "/" + b + "/" + c + "/" + d + ".jpg").replace(/-(\d+)/gi, "M$1")
	};
	var Wa = new Pc("\u536b\u661f", Vc, {
		tips: "\u663e\u793a\u536b\u661f\u5f71\u50cf",
		minZoom: 1,
	...
	x.extend(md.prototype, {
		...
		dV: function() {
			...
			if (this.page < this.If) d = 0 == this.page % this.If ? this.page - this.If - 1 : this.page - this.page % this.If + 1, b = d + this.If - 1;
			else {
			...
			this.page > this.ud - this.If && this.page >= this.If && (d = this.ud - this.If + 1, b = this.ud);
			for (e = d; e <= b; e++) 0 < e && (e == this.page ? a.push('<span style="margin-right:3px">' + e + "</span>") : 1 <= e && e <= this.ud && (d = '<span><a style="color:#7777cc;margin-right:3px" href="javascript:void(0)" onclick="{temp3}">[' + e + "]</a></span>", a.push(d.replace("{temp3}", "BMap.I('" + this.Q + "').toPage(" + e + ");"))));
	...
	function Geolocation(a) {
		...
		var b = this;
		I.load("othersearch", function() {
			for (var a = 0, d; d = b.ae[a]; a++) b[d.method].apply(b, d.arguments)
		})
	}
	...
	function Ma(a, b) {
		function c() {
			e.k.visible ? ("inter" === e.Qe && e.k.indoorExitControl === o ? x.B.show(e.cA) : x.B.J(e.cA), this.k.closeControl && this.xg && this.C && this.C.Da() === this.A ? x.B.show(e.xg) : x.B.J(e.xg), this.k.forceCloseControl && x.B.show(e.xg)) : (x.B.J(e.xg), x.B.J(e.cA))
		}
		...
		this.k.bS !== o && (this.Jn(), z.uj("cus.fire", "count", "z_loadpanoramacount"));
		this.TS(this.A);
	...
	x.extend(Ma.prototype, {
		...
		Gs: t("Qe"),
		ey: function(a) {
			a !== this.Qe && (this.Qe = a, this.dispatchEvent(new N("onscene_type_changed")))
		},
		dc: function(a, b, c) {
			"object" === typeof b && (c = b, b = j);
			a != this.Na && (this.Wk = this.Na, this.Xk = this.zb, this.Na = a, this.Qe = b || "street", this.zb = p, c && c.pov && this.xd(c.pov))
		},
		ha: function(a) {
			a.$a(this.zb) || (this.Wk = this.Na, this.Xk = this.zb, this.zb = a, this.Na = p)
		},
		xd: function(a) {
			a && (this.za = a, a = this.za.pitch, "cvsRender" == this.Dj() || Id() ? (90 < a && (a = 90), -90 > a && (a = -90)) : "cssRender" == this.Dj() && (45 < a && (a = 45), -45 > a && (a = -45)), this.gr = o, this.za.pitch = a)
		},
		Dc: function(a) {
			a != this.Ac && (a > Gd && (a = Gd), a < Hd && (a = Hd), a != this.Ac && (this.Ac = a))
		},
		bB: function() {
			if (this.C) for (var a = this.C.Yw(), b = 0; b < a.length; b++)(a[b] instanceof T || a[b] instanceof pc) && a[b].point && this.ka.push(a[b])
		},
		XE: ba("C"),
		yt: function(a) {
			this.wf = a || "none"
		...
		JE: function(a) {
			for (var b = this.Fg.length; b--;) this.Fg[b] === a && this.Fg.splice(b, 1)
		}
	});
	var Jd = Ma.prototype;
	S(Jd, {
	...
	x.extend(Ld.prototype, {
		...
		Dn: function() {
			var a = 0,
				b, c;
			this.G && (b = this.G.V(), (c = this.V()) && !c.$a(b) && (a = R.Fo(b, c)));
			return a
		},
		J: function() {
			aa("hide\u65b9\u6cd5\u672a\u5b9e\u73b0")
	...
	function Id() {
		if ("boolean" === typeof Qd) return Qd;
		if (!window.WebGLRenderingContext || x.platform.om && -1 == navigator.userAgent.indexOf("Android 5")) return Qd = q;
		var a = document.createElement("canvas"),
			b = p;
		try {
	...
	x.extend($b.prototype, {
		P: function() {
			function a(a) {
				...
				} else b.Na = b.Wk, b.zb = b.Xk, b.dispatchEvent(new N("onnoresult"))
			}
			var b = this.G,
				c = this;
	...
	var Vd = document,
		Wd = Math,
		Xd = Vd.createElement("div").style,
		Yd;
	a: {
		for (var Zd = ["t", "webkitT", "MozT", "msT", "OT"], $d, ae = 0, be = Zd.length; ae < be; ae++) if ($d = Zd[ae] + "ransform", $d in Xd) {
	...
	var ce = Yd ? "-" + Yd.toLowerCase() + "-" : "",
		...
		ye = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
	function(a) {
	...
	function Be(a, b) {
		...
		c.P(se, window);
		c.P(te);
		!pe && "none" != c.options.oO && (c.P("DOMMouseScroll"), c.P("mousewheel"));
	...
	Be.prototype = {
		...
		nv: function(a) {
			var b;
			this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = Vd.createElement("div"), this.options.QE ? b.className = this.options.QE + a.toUpperCase() : b.style.cssText = "position:absolute;z-index:100;" + ("h" == a ? "height:7px;bottom:1px;left:2px;right:" + (this.pi ? "7" : "2") + "px" : "width:7px;bottom:" + (this.$h ? "7" : "2") + "px;top:2px;right:1px"), b.style.cssText += ";pointer-events:none;" + ce + "transition-property:opacity;" + ce + "transition-duration:" + (this.options.QV ? "350ms" : "0") + ";overflow:hidden;opacity:" + (this.options.kx ? "0" : "1"), this.Zm.appendChild(b), this[a + "ScrollbarWrapper"] = b, b = Vd.createElement("div"), this.options.QE || (b.style.cssText = "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" + ce + "background-clip:padding-box;" + ce + "box-sizing:border-box;" + ("h" == a ? "height:100%" : "width:100%") + ";" + ce + "border-radius:3px;border-radius:3px"), b.style.cssText += ";pointer-events:none;" + ce + "transition-property:" + ce + "transform;" + ce + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);" + ce + "transition-duration:0;" + ce + "transform: translate(0,0)" + Ae, this.options.oi && (b.style.cssText += ";" + ce + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)"), this[a + "ScrollbarWrapper"].appendChild(b), this[a + "ScrollbarIndicator"] = b), "h" == a ? (this.gL = this.hL.clientWidth, this.hX = Wd.max(Wd.round(this.gL * this.gL / this.ay), 8), this.gX.style.width = this.hX + "px") : (this.gO = this.hO.clientHeight, this.o_ = Wd.max(Wd.round(this.gO * this.gO / this.op), 8), this.n_.style.height = this.o_ + "px"), this.WA(a, o)) : this[a + "ScrollbarWrapper"] && (qe && (this[a + "ScrollbarIndicator"].style[ee] = ""), this[a + "ScrollbarWrapper"].parentNode.removeChild(this[a + "ScrollbarWrapper"]), this[a + "ScrollbarWrapper"] = p, this[a + "ScrollbarIndicator"] = p)
		},
		VA: function() {
			var a = this;
			setTimeout(function() {
		...
		fr: function(a, b) {
			this.Dk || (a = this.So ? a : 0, b = this.Xm ? b : 0, this.options.Bk ? this.Cb.style[ee] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + Ae : (a = Wd.round(a), b = Wd.round(b), this.Cb.style.left = a + "px", this.Cb.style.top = b + "px"), this.x = a, this.y = b, this.WA("h"), this.WA("v"))
		},
		WA: function(a, b) {
			var c = "h" == a ? this.x : this.y;
			this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.ZC || (c = this[a + "ScrollbarIndicatorSize"] + Wd.round(3 * c), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px"), c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.ZC ? c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - Wd.round(3 * (c - this[a + "ScrollbarMaxScroll"])), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px", c = this[a + "ScrollbarMaxScroll"] + (this[a + "ScrollbarIndicatorSize"] - c))), this[a + "ScrollbarWrapper"].style[je] = "0", this[a + "ScrollbarWrapper"].style.opacity = b && this.options.kx ? "0" : "1", this[a + "ScrollbarIndicator"].style[ee] = "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + Ae)
		},
		VP: function(a) {
			if (a.RQ === o) return this.uB = a.target, this.Jw = Date.now(), o;
			if (this.uB && this.Jw) {
				if (600 < Date.now() - this.Jw) return this.Jw = this.uB = p, o
			} else {
				for (var b = a.target; b != this.Cb && b != document.body;) b = b.parentNode;
				if (b == document.body) return o
			}
			for (b = a.target; 1 != b.nodeType;) b = b.parentNode;
			b = b.tagName.toLowerCase();
			if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.BY = o, a.stopPropagation(), a.preventDefault(), this.Jw = this.uB = p, q
		},
		xv: function(a) {
			...
			if (this.enabled) {
				...
				this.options.zoom && (pe && 1 < a.touches.length) && (d = Wd.abs(a.touches[0].pageX - a.touches[1].pageX), c = Wd.abs(a.touches[0].pageY - a.touches[1].pageY), this.WZ = Wd.sqrt(d * d + c * c), this.Kx = Wd.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.wF) / 2 - this.x, this.Lx = Wd.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.xF) / 2 - this.y, this.options.dp && this.options.dp.call(this, a));
				if (this.options.Cx && (this.options.Bk ? (c = getComputedStyle(this.Cb, p)[ee].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Cb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Cb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.oi ? this.Jd(xe) : ze(this.CB), this.mj = [], this.fr(d, c), this.options.Ix && this.options.Ix.call(this);
				this.Qv = this.x;
				this.Rv = this.y;
				this.Kt = this.x;
				this.Lt = this.y;
		...
		qS: function(a) {
			...
			if (this.options.zoom && pe && 1 < a.touches.length) e = Wd.abs(a.touches[0].pageX - a.touches[1].pageX), f = Wd.abs(a.touches[0].pageY - a.touches[1].pageY), this.VZ = Wd.sqrt(e * e + f * f), this.Dk = o, b = 1 / this.WZ * this.VZ * this.scale, b < this.options.Ck ? b = 0.5 * this.options.Ck * Math.pow(2, b / this.options.Ck) : b > this.options.Hp && (b = 2 * this.options.Hp * Math.pow(0.5, this.options.Hp / b)), this.Yo = b / this.scale, e = this.Kx - this.Kx * this.Yo + this.x, f = this.Lx - this.Lx * this.Yo + this.y, this.Cb.style[ee] = "translate(" + e + "px," + f + "px) scale(" + b + ")" + Ae, this.options.GM && this.options.GM.call(this, a);
			else {
				this.gh = b.pageX;
				this.hh = b.pageY;
				if (0 < e || e < this.Ud) e = this.options.ko ? this.x + c / 2 : 0 <= e || 0 <= this.Ud ? 0 : this.Ud;
				if (f > this.$e || f < this.bd) f = this.options.ko ? this.y + d / 2 : f >= this.$e || 0 <= this.bd ? this.$e : this.bd;
				this.uC += c;
				this.vC += d;
				this.Ov = Wd.abs(this.uC);
				this.Pv = Wd.abs(this.vC);
				6 > this.Ov && 6 > this.Pv || (this.options.iE && (this.Ov > this.Pv + 5 ? (f = this.y, d = 0) : this.Pv > this.Ov + 5 && (e = this.x, c = 0)), this.dh = o, this.fr(e, f), this.oC = 0 < c ? -1 : 0 > c ? 1 : 0, this.pC = 0 < d ? -1 : 0 > d ? 1 : 0, 300 < g - this.startTime && (this.startTime = g, this.Kt = this.x, this.Lt = this.y), this.options.DM && this.options.DM.call(this, a))
			}
		},
		Ju: function(a) {
			if (!(pe && 0 !== a.touches.length)) {
				...
				if (b.Dk) d = b.scale * b.Yo, d = Math.max(b.options.Ck, d), d = Math.min(b.options.Hp, d), b.Yo = d / b.scale, b.scale = d, b.x = b.Kx - b.Kx * b.Yo + b.x, b.y = b.Lx - b.Lx * b.Yo + b.y, b.Cb.style[ge] = "200ms", b.Cb.style[ee] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Ae, b.Dk = q, b.refresh(), b.options.cp && b.options.cp.call(b, a);
				else {
					if (b.dh) {
						if (300 > i && b.options.Cx) {
							...
							d = b.x + f.oa;
							e = b.y + g.oa;
							if (0 < b.x && 0 < d || b.x < b.Ud && d < b.Ud) f = {
								oa: 0,
								time: 0
							};
							if (b.y > b.$e && e > b.$e || b.y < b.bd && e < b.bd) g = {
								oa: 0,
								time: 0
							}
						}
						f.oa || g.oa ? (c = Wd.max(Wd.max(f.time, g.time), 10), b.options.Ht && (f = d - b.Qv, g = e - b.Rv, Wd.abs(f) < b.options.ly && Wd.abs(g) < b.options.ly ? b.scrollTo(b.Qv, b.Rv, 200) : (f = b.CI(d, e), d = f.x, e = f.y, c = Wd.max(f.time, c))), b.scrollTo(Wd.round(d), Wd.round(e), c)) : b.options.Ht ? (f = d - b.Qv, g = e - b.Rv, Wd.abs(f) < b.options.ly && Wd.abs(g) < b.options.ly ? b.scrollTo(b.Qv, b.Rv, 200) : (f = b.CI(b.x, b.y), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) : b.Qn(200)
					} else {
						if (pe) if (b.dK && b.options.zoom) clearTimeout(b.dK), b.dK = p, b.options.dp && b.options.dp.call(b, a), b.zoom(b.gh, b.hh, 1 == b.scale ? b.options.yV : 1), b.options.cp && setTimeout(function() {
							b.options.cp.call(b, a)
						}, 200);
						else if (this.options.gx) {
							for (d = c.target; 1 != d.nodeType;) d = d.parentNode;
							e = d.tagName.toLowerCase();
							"select" != e && "input" != e && "textarea" != e ? (e = Vd.createEvent("MouseEvents"), e.initMouseEvent("click", o, o, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, 0, p), e.RQ = o, d.dispatchEvent(e)) : d.focus()
						}
						b.Qn(400)
					}
		...
		Qn: function(a) {
			...
			if (b == this.x && c == this.y) {
				if (this.dh && (this.dh = q, this.options.Ix && this.options.Ix.call(this)), this.$h && this.options.kx && ("webkit" == Yd && (this.hL.style[je] = "300ms"), this.hL.style.opacity = "0"), this.pi && this.options.kx)"webkit" == Yd && (this.hO.style[je] = "300ms"), this.hO.style.opacity = "0"
		...
		VT: function(a) {
			...
			if ("zoom" == b.options.oO) {
				if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Ck && (d = b.options.Ck), d > b.options.Hp && (d = b.options.Hp), d != b.scale)!b.yy && b.options.dp && b.options.dp.call(b, a), b.yy++, b.zoom(a.pageX, a.pageY, d, 400), setTimeout(function() {
					b.yy--;
					!b.yy && b.options.cp && b.options.cp.call(b, a)
				}, 400)
			} else c = b.x + c, d = b.y + d, 0 < c ? c = 0 : c < b.Ud && (c = b.Ud), d > b.$e ? d = b.$e : d < b.bd && (d = b.bd), 0 > b.bd && b.scrollTo(c, d, 0)
		},
		RT: function(a) {
			a.target == this.Cb && (this.Jd(xe), this.hB())
		},
		hB: function() {
			var a = this,
				b = a.x,
				...
				d = Date.now(),
				e, f, g;
			a.Cl || (a.mj.length ? (e = a.mj.shift(), e.x == b && e.y == c && (e.time = 0), a.Cl = o, a.dh = o, a.options.oi) ? (a.LI(e.time), a.fr(e.x, e.y), a.Cl = q, e.time ? a.P(xe) : a.Qn(0)) : (g = function() {
				var i = Date.now(),
					k;
				if (i >= d + e.time) {
					a.fr(e.x, e.y);
		...
		Kj: function(a) {
			...
			a != this.Zm && (b *= this.scale, c *= this.scale);
			return {
				left: b,
				top: c
			}
		...
		CI: function(a, b) {
			...
			e = this.Fe.length - 1;
			c = 0;
			for (d = this.Fe.length; c < d; c++) if (a >= this.Fe[c]) {
				e = c;
				break
			}
		...
		refresh: function() {
			...
			if ("string" == typeof this.options.Ht) {
				...
				a = 0;
				for (b = c.length; a < b; a++) d = this.Kj(c[a]), d.left += this.wF, d.top += this.xF, this.Fe[a] = d.left < this.Ud ? this.Ud : d.left * this.scale, this.bf[a] = d.top < this.bd ? this.bd : d.top * this.scale
			} else if (this.options.Ht) {
				for (this.Fe = []; d >= this.Ud;) this.Fe[b] = d, d -= this.au, b++;
				this.Ud % this.au && (this.Fe[this.Fe.length] = this.Ud - this.Fe[this.Fe.length - 1] + this.Fe[this.Fe.length - 1]);
				b = d = 0;
				for (this.bf = []; d >= this.bd;) this.bf[b] = d, d -= this.$m, b++;
				this.bd % this.$m && (this.bf[this.bf.length] = this.bd - this.bf[this.bf.length - 1] + this.bf[this.bf.length - 1])
			}
			this.nv("h");
			this.nv("v");
			this.Dk || (this.Cb.style[ge] = "0", this.Qn(400))
		},
		scrollTo: function(a, b, c, d) {
			...
			a = 0;
			for (b = e.length; a < b; a++) e[a].CY && (e[a].x = this.x - e[a].x, e[a].y = this.y - e[a].y), this.mj.push({
				x: e[a].x,
				y: e[a].y,
				time: e[a].time || 0
			});
		...
		zoom: function(a, b, c, d) {
			var e = c / this.scale;
			this.options.Bk && (this.Dk = o, d = d === j ? 200 : d, a = a - this.wF - this.x, b = b - this.xF - this.y, this.x = a - a * e + this.x, this.y = b - b * e + this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.Ud ? this.Ud : this.x, this.y = this.y > this.$e ? this.$e : this.y < this.bd ? this.bd : this.y, this.Cb.style[ge] = d + "ms", this.Cb.style[ee] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + Ae, this.Dk = q)
		}
	};
	...
	z.Bm(function(a) {
		...
		a.addEventListener("position_changed", function() {
			a.k.visible && a.k.albumsControl === o && (b ? b.Vx(a.Mb()) : (b = new Ce(a.k.albumsControlOptions), b.fa(a)))
		});
		a.addEventListener("albums_visible_changed", function() {
			a.k.albumsControl === o ? (b ? b.Vx(a.Mb()) : (b = new Ce(a.k.albumsControlOptions), b.fa(a)), b.show()) : b.J()
		});
	...
	x.extend(Ce.prototype, {
		...
		dH: function(a) {
			for (var b = this.Lj, c = b.length - 1; 0 <= c; c--) if (b[c].panoId == a) return c;
			return -1
		},
		Vx: function(a, b) {
		...
		eV: function() {
			if (!this.zi) {
				...
				for (var c = this, d = b.getElementsByTagName("span"), e = 0, f = d.length; e < f; e++) b = d[e], x.F(b, "click", function() {
		...
		bV: function() {
			if (this.zi) a = this.IK(this.Ci), this.KP.innerHTML = a;
			else {
				...
				x.F(b, "click", function(a) {
					if (a = (a.srcElement || a.target).getAttribute("dataindex")) {
						c.kl(c.wG[a]);
						for (var d = b.getElementsByTagName("li"), e = 0, f = d.length; e < f; e++) d[e].childNodes[0].getAttribute("dataindex") === a ? x.B.Oa(d[e], "pano_catlogLiActive") : x.B.Pb(d[e], "pano_catlogLiActive")
					}
				});
				var a = K("div"),
					d = K("a"),
		...
		kl: function(a) {
			this.Lj = a;
			this.k.showCatalog && (0 < this.Ci.length ? (Sa() ? this.bV() : this.eV(), this.Ec.offsetLeft = 60) : (this.ls && (this.A.removeChild(this.ls), this.ls = p, this.Ec.Tf.style.left = "0px"), this.zi && (this.A.removeChild(this.zi), this.zi = p), this.Ec.offsetLeft = 0));
			var b = this.sW(a);
			Sa() && (this.Ci && 0 < this.Ci.length && this.k.showExit && this.Fz) && (this.Ec.offsetLeft += this.Sf.width + 8, this.ls ? this.ls.innerHTML = this.Fz : this.cV());
			this.Jh.innerHTML = b;
			this.Jh.style.width = (this.Sf.width + 8) * a.length + 8 + "px";
			a = this.A.offsetWidth;
			b = this.Jh.offsetWidth;
			this.Ec.ws && (b += this.Ec.ws());
			b < a - 2 * this.Ec.ti - this.Ec.offsetLeft ? this.A.style.width = b + this.Ec.offsetLeft + "px" : (this.A.style.width = isNaN(Number(this.k.maxWidth)) === o ? this.k.maxWidth : this.k.maxWidth + "px", b < this.A.offsetWidth - 2 * this.Ec.ti - this.Ec.offsetLeft && (this.A.style.width = b + this.Ec.offsetLeft + "px"));
			this.Ec.refresh();
			this.XA = this.Jh.children;
			this.Jh.appendChild(this.Oj);
			this.Oj.style.left = "-100000px";
			a = this.dH(this.G.Mb(), this.n0); - 1 !== a && this.sp(a)
		},
		yW: function(a) {
		...
		tP: function() {
			...
			x.F(this.Pj, "click", function(b) {
				if ((b = (b.srcElement || b.target).getAttribute("data-index")) && b != a.Nc) a.sp(b), a.G.dc(a.Lj[b].panoId)
			});
